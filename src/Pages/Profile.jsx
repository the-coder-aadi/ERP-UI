...
function Profile() {
  ...
  return (
    <div className="h-screen grid  overflow-hidden grid-cols-[0.2fr_1fr] 
...
max-[768px]:grid-cols-1 ">
      ...
      <div className="bg-[#f1f1f1] h-full text-black flex flex-col max-[768px]:hidden ">
    ...
    max-[900px]:mt-[15px]">
      ...
      <div className="grid gap-[10px] overflow-y-auto
  ...
  pb-[60px] md:pb-0">
        ...
        <div className="max-w-4xl p-5 md:p-8 mb-4  text-[#4A4A4A] font-sans">
          ...
          <div className="flex justify-end items-center gap-8 mt-12">
            ...
            <button className="bg-[#1A1A1A] cursor-pointer text-white px-5 py-2 md:px-9 md:py-3 rounded-sm text-sm font-semibold hover:bg-[#000000c2] transition-all duration-300  hover:-translate-y-[2px]" onClick={()=> navigate("/super-admin/dashboard")}>
              Save Changes
            </button>
          </div>
        </div>
